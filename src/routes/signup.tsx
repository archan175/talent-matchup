...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Sign Up — ERUKA" },
      { name: "description", content: "Create your ERUKA account and start freelancing or hiring." },
    ],
  }),
    ...
    <div className="flex min-h-[calc(100vh-8rem)] items-center justify-center px-4 py-8">
      <Card className="w-full max-w-md gradient-card border-border/50">
        <CardContent className="p-8">
          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert("Signed up!"); }}>
            {/* Role selector */}
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input placeholder="John Doe" value={name} onChange={(e) => setName(e.target.value)} className="pl-10 bg-input/50" />
              </div>
            </div>
            <div>
